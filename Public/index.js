...
PIXI.loader
  .add("https://raw.githubusercontent.com/DnD-DevMtn/Dungeons-Dragons/master/public/assets/login-sprites.json")
  .load(setup);

function setup() {
  close = new PIXI.extras.TilingSprite(
    resources["https://raw.githubusercontent.com/DnD-DevMtn/Dungeons-Dragons/master/public/assets/login-sprites.json"].textures["town.png"],
    512, 512
  );
  mid = new PIXI.extras.TilingSprite(
    resources["https://raw.githubusercontent.com/DnD-DevMtn/Dungeons-Dragons/master/public/assets/login-sprites.json"].textures["church-castle.png"],
    512, 512
  );
  far = new PIXI.extras.TilingSprite(
    resources["https://raw.githubusercontent.com/DnD-DevMtn/Dungeons-Dragons/master/public/assets/login-sprites.json"].textures["castle1.png"],
    512, 512
  );
  farthest = new PIXI.extras.TilingSprite(
    resources["https://raw.githubusercontent.com/DnD-DevMtn/Dungeons-Dragons/master/public/assets/login-sprites.json"].textures["castle2.png"],
    512, 512
  );
